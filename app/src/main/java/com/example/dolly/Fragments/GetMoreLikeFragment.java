...
public class GetMoreLikeFragment extends Fragment {
    View view;
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.do_like_fragment, container, false);
        recyclerView=(RecyclerView)view.findViewById(R.id.recyclerView);
        progressBar=(ProgressBar)view.findViewById(R.id.progressNearBy);
        likes=(RelativeLayout)view.findViewById(R.id.likesRelative);
        noLikes=(RelativeLayout)view.findViewById(R.id.noLikesRelative);
...
//        oppositeGender = prefs.getString("oppositeGender", "");
    ...
    public void dummyData()
    {
        ...
        try {
            final DatabaseReference profileDb = FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid()).child("connections").child("likes");
