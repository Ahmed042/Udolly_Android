...
import com.example.datingpro.MainHome;
import com.example.datingpro.MapPlacePicker;
import com.example.datingpro.R;
import com.example.datingpro.SelectProfileImage;
import com.example.datingpro.Settings;
import com.example.datingpro.SignUp;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        SelectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dismiss();
                BaseHelper.location=myAddress.getText().toString();
                BaseHelper.locationLat=Lat.toString();
                BaseHelper.locationLong=Long.toString();
                Intent intent = new Intent(getActivity(), SelectProfileImage.class);
                ((MapPlacePicker) getActivity()).startActivity(intent);
                Animatoo.animateFade(getContext());
                ((MapPlacePicker) getActivity()).finish();
